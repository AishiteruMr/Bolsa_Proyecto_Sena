...
export default function InstructorAsignado({ instructorNombre, proyecto, totalPostulaciones }) {
  const styles = {
    container: {
    ...
    postulationsText: { margin: 0, color: "#065f46", fontSize: "15px", fontWeight: 600 },
    postulationsNote: { margin: "8px 0 0 0", color: "#065f46", opacity: 0.8, fontSize: "13px" },
    ...
    <div style={styles.container}>
      <div style={styles.mainCard}>
        <div style={styles.header}>
          ...
          <h1 style={styles.headerTitle}>Nuevo Proyecto Asignado</h1>
          <p style={styles.headerSubtitle}>Se te ha asignado un proyecto para supervisar</p>
        </div>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.projectCard}>
            ...
            <div style={styles.projectMeta}>
              📅 <span style={styles.projectLabel}>Publicado:</span> {formatDate(proyecto?.fecha_publicacion)}
            </div>
            
            {proyecto?.fecha_finalizacion && (
              <div style={styles.projectMeta}>
                🏁 <span style={styles.projectLabel}>Finalización estimada:</span> {formatDate(proyecto?.fecha_finalizacion)}
              </div>
            )}
            
            {proyecto?.duracion_estimada_dias && (
              <div style={styles.projectMeta}>
                ⏳ <span style={styles.projectLabel}>Duración:</span> {proyecto?.duracion_estimada_dias} días
              </div>
            )}
            ...
            {proyecto?.habilidades_requeridas && (
              <div style={styles.requirementsSection}>
                <p style={styles.reqLabel}><strong>💡 Habilidades que supervisa:</strong></p>
          ...
          {totalPostulaciones > 0 && (
            <div style={styles.postulationsBox}>
              <p style={styles.postulationsText}>
                👥 {totalPostulaciones} {totalPostulaciones === 1 ? 'postulación pendiente' : 'postulaciones pendientes'} de revisión
              </p>
              <p style={styles.postulationsNote}>
                Ingresa a tu panel para revisar y aprobar/rechazar candidatos.
              </p>
            </div>
          )}
