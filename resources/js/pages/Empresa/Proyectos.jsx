      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', marginBottom: '40px', maxWidth: '600px' }}>
            Administra tus proyectos y las postulaciones de aprendices.
          </p>

          <Link href="/empresa/proyectos/crear" className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px' }}>
      ...
      <div style={{ background: 'white', borderRadius: '24px', overflow: 'hidden', boxShadow: 'var(--shadow)' }}>
              ...
              <tr key={proyecto.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                ...
                <td style={{ padding: '20px 24px' }}>
                  <span style={{
                    ...
                    fontSize: '12px',
                    fontWeight: 600,
                    background: proyecto.estado === 'aprobado' ? '#dcfce7' : proyecto.estado === 'en_progreso' ? '#dbeafe' : '#fef3c7',
                    color: proyecto.estado === 'aprobado' ? '#166534' : proyecto.estado === 'en_progreso' ? '#1e40af' : '#92400e'
                  }}>
                    {proyecto.estado}
                  </span>
                </td>
                ...
                <td style={{ padding: '20px 24px', textAlign: 'right' }}>
                  <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                    <Link href={`/empresa/proyectos/${proyecto.id}/editar`} style={{
                      padding: '8px 16px',
                      borderRadius: '10px',
                      background: '#f1f5f9',
                      color: '#475569',
                    ...
                    <Link href={`/empresa/proyectos/${proyecto.id}/postulantes`} style={{
                      padding: '8px 16px',
                      borderRadius: '10px',
        ...
        {proyectos?.length === 0 && (
          <div style={{ padding: '60px', textAlign: 'center' }}>
            ...
            <h3 style={{ fontSize: '20px', fontWeight: 700, marginBottom: '8px' }}>No hay proyectos aún</h3>
            <p style={{ color: 'var(--text-light)', marginBottom: '24px' }}>Crea tu primer proyecto para comenzar a recibir postulaciones.</p>
            <Link href="/empresa/proyectos/crear" className="btn btn-primary">
              <i className="fas fa-plus"></i> Crear Proyecto
            </Link>
          </div>
        )}
      </div>
