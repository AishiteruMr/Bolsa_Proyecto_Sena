        ...
        <div style="padding:36px 40px;">
            ...
            <div style="background:#f8fbf5; border:1px solid #d4edcc; border-radius:12px; padding:24px; margin-bottom:24px;">
                ...
                <table style="width:100%; border-collapse:collapse;">
                    ...
                    <tr>
                        <td style="padding:8px 0; color:#555; font-size:14px;">
                            📅 <strong>Publicado:</strong> {{ \Carbon\Carbon::parse($proyecto->pro_fecha_publi)->format('d/m/Y') }}
                        </td>
                    </tr>
                    @if(!empty($proyecto->pro_fecha_finalizacion))
                    <tr>
                        <td style="padding:8px 0; color:#555; font-size:14px;">
                            🏁 <strong>Finalización estimada:</strong> {{ \Carbon\Carbon::parse($proyecto->pro_fecha_finalizacion)->format('d/m/Y') }}
                        </td>
                    </tr>
                    @endif
