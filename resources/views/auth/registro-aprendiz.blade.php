...
<div class="registro-container">
    ...
    <form action="{{ route('registro.aprendiz.post') }}" method="POST">
        ...
        <div class="form-group input-icon">
            ...
            <input type="text" name="programa" value="{{ old('programa') }}" placeholder="Programa de formación SENA" required>
            <div class="form-hint">
                <i class="fas fa-info-circle hint-icon" data-hint="Nombre completo del programa técnico o tecnológico"></i>
                Ej: Análisis y Desarrollo de Software
            </div>
        </div>
        ...
        <div class="form-group input-icon">
            ...
            <div class="form-hint">
                <i class="fas fa-info-circle hint-icon" data-hint="Correo personal o institucional activo"></i>
