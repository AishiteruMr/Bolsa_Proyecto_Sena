...
@section('styles')
<style>
    body { background: linear-gradient(135deg, #4a0080, #8e44ad); min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 20px; }
    ...
    .header h2 { font-size: 20px; font-weight: 700; color: #4a0080; }
    ...
    .input-icon input:focus { border-color: #8e44ad; }
    .btn-submit { width: 100%; padding: 13px; background: linear-gradient(135deg, #8e44ad, #6c3483); color: #fff; border: none; border-radius: 30px; font-family: 'Poppins', sans-serif; font-size: 15px; font-weight: 600; cursor: pointer; margin-top: 8px; }
    ...
    .link-text a { color: #8e44ad; font-weight: 500; }
