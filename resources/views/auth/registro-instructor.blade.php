...
@section('styles')
<style>
    body { background: linear-gradient(135deg, #003080, #2980b9); min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 20px; }
    ...
    .header h2 { font-size: 20px; font-weight: 700; color: #003080; }
    ...
    .input-icon input:focus { border-color: #2980b9; }
    .input-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
    .btn-submit { width: 100%; padding: 13px; background: linear-gradient(135deg, #2980b9, #1a6090); color: #fff; border: none; border-radius: 30px; font-family: 'Poppins', sans-serif; font-size: 15px; font-weight: 600; cursor: pointer; margin-top: 8px; }
    ...
    .link-text a { color: #2980b9; font-weight: 500; }
...
<div class="container">
    ...
    <form action="{{ route('registro.instructor.post') }}" method="POST">
        ...
        <div class="form-group input-icon">
            ...
            <input type="text" name="especialidad" value="{{ old('especialidad') }}" placeholder="Especialidad" required>
        </div>
        <div class="form-group input-icon">
