...
<div class="register-page-wrapper">
    ...
    <div class="register-container">
        ...
        <div class="register-content">
            ...
            <form action="{{ route('registro.instructor.post') }}" method="POST" id="registroForm">
                @csrf
                ...
                <div class="form-step" data-step="2">
                    <h4 class="step-title">Paso 2: Información profesional</h4>
                    <div class="form-group">
                        <label>Especialización SENA <i class="fas fa-question-circle hint-icon" data-hint="Área en la que enseñas"></i></label>
                        <div class="input-wrapper">
                ...
                <div class="form-step" data-step="3">
                    ...
                    <div class="form-group">
                        <div style="display: flex; align-items: center; gap: 10px;">
                            ...
                            <label for="terminos" style="margin:0; font-size: 13px; color: var(--text-light);">Acepto los <a href="{{ route('terminos.condiciones') }}" target="_blank" style="color: var(--primary); text-decoration: underline;">Términos y Condiciones</a></label>
                        </div>
                    </div>

                    <div class="form-group">
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <input type="checkbox" id="consentimiento_datos" name="consentimiento_datos" required style="width: 16px; height: 16px; accent-color: var(--primary);">
                            <label for="consentimiento_datos" style="margin:0; font-size: 13px; color: var(--text-light);">
                                Autorizo el tratamiento de mis datos personales conforme a la <a href="{{ route('politica.datos') }}" target="_blank" style="color: var(--primary); text-decoration: underline;">Política de Tratamiento de Datos</a> (Ley 1581 de 2012)
                            </label>
                        </div>
                    </div>
                </div>
