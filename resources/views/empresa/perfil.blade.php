...
<div class="max-w-7xl mx-auto space-y-12 pb-24 italic font-bold">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 px-4 italic">
        ...
        <x-card class="lg:col-span-2 overflow-hidden border-none shadow-2xl relative group rounded-[4rem] bg-slate-900 italic" shadow="none">
            <div class="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-orange-900/50 opacity-90 italic"></div>
            <div class="relative p-12 flex flex-col md:flex-row items-center gap-12 italic">
                <div class="relative shrink-0 italic">
                    ...
                    <div class="absolute -bottom-4 -right-4 w-16 h-16 bg-[#FF6B00] rounded-[2rem] flex items-center justify-center border-8 border-slate-900 shadow-2xl text-white italic rotate-12">
                ...
                <div class="flex-1 text-center md:text-left space-y-6 italic">
                    <div class="flex flex-wrap items-center justify-center md:justify-start gap-4 italic">
                        <x-badge class="bg-[#FF6B00] text-white border-none px-6 py-2 rounded-full font-black tracking-[0.2em] text-[10px] uppercase italic italic shadow-lg shadow-[#FF6B00]/20 italic">
                    ...
                    <div class="flex flex-col md:flex-row gap-8 pt-4 text-orange-400/80 font-black text-[11px] uppercase tracking-widest italic italic">
                        <div class="flex items-center gap-3 italic">
                            <i class="fas fa-user-tie text-[#FF6B00] italic"></i>
        ...
        <x-card class="flex flex-col justify-between p-10 border-none shadow-2xl bg-white relative overflow-hidden group rounded-[3.5rem] italic" shadow="none">
            <div class="absolute top-0 right-0 w-48 h-48 bg-orange-50 rounded-full -mr-24 -mt-24 transition-transform group-hover:scale-150 duration-1000 italic opacity-50"></div>
            ...
            <div class="relative space-y-8 italic">
                ...
                <div class="space-y-6 italic">
                    <div class="flex justify-between items-end italic">
                        <span class="text-4xl font-black text-slate-900 italic">100<span class="text-lg text-[#FF6B00]">%</span></span>
                        <x-badge class="bg-orange-50 text-[#E65100] border-none px-4 py-1.5 rounded-full font-black text-[9px] uppercase tracking-widest italic italic italic">OPTIMIZADO</x-badge>
                    </div>
                    <div class="h-4 w-full bg-slate-100 rounded-full overflow-hidden p-1 shadow-inner italic">
                        <div class="h-full bg-[#FF6B00] rounded-full shadow-lg transition-all duration-1000 relative italic" style="width: 100%">
            ...
            <x-button :href="route('empresa.proyectos.crear')" variant="primary" shadow="orange" class="w-full py-6 mt-8 rounded-[2rem] flex items-center justify-center gap-4 font-black uppercase tracking-[0.2em] text-[10px] active:scale-95 transition-all italic italic shadow-2xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-10 px-4 italic">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 italic">
                    <div class="space-y-4 italic">
                        ...
                        <div class="relative group italic">
                            <div class="absolute left-6 top-1/2 -translate-y-1/2 w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-300 group-focus-within:bg-orange-50 group-focus-within:text-[#FF6B00] transition-all italic">
                            ...
                            <input type="text" name="nombre_empresa" value="{{ old('nombre_empresa', $empresa->emp_nombre) }}" required 
                                class="w-full pl-20 pr-8 py-6 rounded-[2rem] bg-slate-50 border-4 border-transparent focus:border-[#FF6B00]/10 focus:bg-white focus:ring-0 transition-all font-black text-slate-700 uppercase italic tracking-tight placeholder:text-slate-200">
                        </div>
                    </div>
                ...
                <div class="p-10 bg-slate-900 rounded-[3rem] border-4 border-white shadow-2xl relative overflow-hidden group italic">
                    ...
                    <div class="relative space-y-8 italic">
                        <div class="flex items-center gap-4 italic">
                            <div class="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-[#FF6B00] italic">
                        ...
                        <div class="space-y-4 italic">
                            <label class="text-[10px] font-black text-[#FF6B00]/60 uppercase tracking-[0.4em] pl-2 italic">ACTUALIZAR LLAVE DE ACCESO</label>
                            <input type="password" name="password" placeholder="INGRESA NUEVA CREDENCIAL SOLO SI DESEAS RE-SINCRONIZAR" 
                                class="w-full px-8 py-6 rounded-[2rem] bg-white/5 border-4 border-transparent focus:border-[#FF6B00]/20 focus:bg-white/10 focus:ring-0 transition-all font-black text-white uppercase italic tracking-widest placeholder:text-white/20 italic">
                        </div>
                    </div>
                </div>

                <div class="flex justify-end pt-8 italic">
                    <x-button type="submit" variant="primary" shadow="orange" class="px-16 py-6 rounded-[2rem] group flex items-center justify-center gap-6 font-black uppercase tracking-[0.2em] text-[11px] active:scale-95 transition-all italic italic shadow-2xl">
        ...
        <div class="space-y-10 sticky top-12 italic">
                ...
                <div class="space-y-6 italic">
                    <div class="p-8 bg-slate-50 rounded-[2.5rem] border-2 border-white shadow-inner italic">
                        ...
                        <div class="flex items-baseline gap-4 italic">
                            ...
                            <x-badge class="bg-orange-50 text-[#E65100] border-none px-4 py-1.5 rounded-full font-black text-[9px] uppercase tracking-widest italic italic shadow-sm italic ring-1 ring-orange-100">MISIÓN OK</x-badge>
                        </div>
                    </div>
                    <div class="p-8 bg-[#E65100] rounded-[2.5rem] shadow-2xl shadow-[#FF6B00]/30 text-white relative overflow-hidden group italic">
            ...
            <x-card class="p-10 border-none bg-slate-900 text-white shadow-2xl rounded-[3rem] space-y-8 relative overflow-hidden group italic" shadow="none">
                <div class="absolute -right-8 -bottom-8 w-48 h-48 bg-[#FF6B00]/10 rounded-full blur-[80px] italic"></div>
                <div class="relative space-y-6 italic">
                    <div class="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center text-orange-400 shadow-2xl italic">
