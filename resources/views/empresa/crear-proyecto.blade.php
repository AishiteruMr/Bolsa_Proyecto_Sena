                            ...
                            <div>
                                ...
                                <div style="position: relative;">
                                    ...
                                    <select name="categoria" required style="width: 100%; padding: 14px 16px 14px 48px; border: 1.5px solid #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 600; outline: none; background: white; appearance: none;">
                                        ...
                                        <option value="Tecnología" {{ old('categoria') == 'Tecnología' ? 'selected' : ''}}>Tecnología e Información</option>
                                        <option value="Agrícola" {{ old('categoria') == 'Agrícola' ? 'selected' : ''}}>Gestión Agrícola</option>
                                        <option value="Industrial" {{ old('categoria') == 'Industrial' ? 'selected' : ''}}>Manufactura Industrial</option>
                                        <option value="Salud" {{ old('categoria') == 'Salud' ? 'selected' : ''}}>Salud y Bienestar</option>
                                        <option value="Ambiental" {{ old('categoria') == 'Ambiental' ? 'selected' : ''}}>Sostenibilidad Ambiental</option>
                                        <option value="Otro" {{ old('categoria') == 'Otro' ? 'selected' : ''}}>Otros Sectores</option>
                                    </select>
                            ...
                            <div style="background: #f8fafc; padding: 28px; border-radius: 20px; border: 1.5px solid #e2e8f0; display: grid; gap: 20px;">
                                <div>
                                    ...
                                    <div style="position: relative;">
                                        ...
                                        <input type="date" name="fecha_publi" id="fecha_publi" min="{{ date('Y-m-d') }}" value="{{ old('fecha_publi', date('Y-m-d')) }}" required style="width: 100%; padding: 12px 16px 12px 48px; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 600; outline: none; background: white;">
                                    </div>
                                </div>
