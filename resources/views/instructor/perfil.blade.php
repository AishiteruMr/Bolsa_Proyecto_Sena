...
<div class="max-w-7xl mx-auto space-y-12 pb-24 italic font-bold">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 px-4 italic">
        <!-- Mentor Profile Card -->
        <div class="lg:col-span-2 relative overflow-hidden rounded-[4rem] bg-slate-900 p-12 md:p-16 shadow-2xl shadow-[#FF6B00]/10 text-white italic group italic">
            <div class="absolute -right-20 -bottom-20 rotate-[-15deg] text-[300px] text-[#FF6B00]/5 opacity-40 pointer-events-none group-hover:rotate-0 transition-all duration-1000 italic font-bold">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center gap-12 md:gap-16 italic font-bold">
                <div class="relative italic">
                    <div class="w-40 h-40 md:w-56 md:h-56 rounded-[3.5rem] bg-[#FF6B00] flex items-center justify-center text-8xl font-black shadow-2xl shadow-[#FF6B00]/40 border-8 border-white/10 italic group-hover:scale-110 transition-transform italic leading-none italic">
                ...
                <div class="flex-1 text-center md:text-left space-y-8 italic font-bold">
                    <div class="flex flex-wrap items-center justify-center md:justify-start gap-6 italic">
                        <x-badge class="bg-[#FF6B00] text-white border-none px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-[0.3em] italic shadow-2xl shadow-[#FF6B00]/20 italic">INSTRUCTOR LÍDER</x-badge>
                        <span class="text-white/40 text-[11px] uppercase font-black tracking-[0.4em] flex items-center gap-4 italic leading-none italic">
                            <i class="fas fa-at text-[#FF6B00] italic font-bold"></i> {{ $usuario->usr_correo }}
                        </span>
                    </div>
                    ...
                    <div class="inline-flex items-center gap-5 px-8 py-4 rounded-[2rem] bg-white/5 border-2 border-white/5 text-orange-400 italic shadow-xl italic font-bold">
        ...
        <x-card class="bg-white border-none shadow-2xl rounded-[4rem] p-12 flex flex-col justify-center space-y-12 group italic font-bold" shadow="none">
            <div class="space-y-6 italic">
                ...
                <div class="flex items-center gap-6 italic">
                    <div class="w-5 h-5 rounded-full bg-[#FF6B00] shadow-[0_0_25px_rgba(16,185,129,0.7)] animate-pulse italic"></div>
            ...
            <div class="pt-10 border-t-4 border-slate-50 italic font-bold">
                <p class="text-[10px] font-black text-[#E65100] uppercase tracking-[0.4em] mb-6 italic leading-none italic">JERARQUÍA ESTRATÉGICA</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 px-4 italic font-bold">
        ...
        <div class="lg:col-span-2 italic font-bold">
            <x-card class="p-12 md:p-16 border-none shadow-2xl rounded-[4rem] bg-white relative overflow-hidden group italic font-bold border-4 border-transparent hover:border-[#FF6B00]/5 transition-all italic" shadow="none">
                ...
                <div class="flex items-center justify-between mb-16 italic border-b-4 border-slate-50 pb-10 italic font-bold">
                    <div class="flex items-center gap-6 italic">
                        <div class="w-16 h-16 rounded-2xl bg-slate-900 text-white flex items-center justify-center shadow-2xl italic rotate-6 italic">
                            <i class="fas fa-fingerprint text-2xl italic text-[#FF6B00] font-bold"></i>
                        </div>
                        <div class="italic">
                ...
                <form action="{{ route('instructor.perfil.update') }}" method="POST" class="space-y-12 italic font-bold">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 italic">
                        <div class="space-y-4 italic">
                            ...
                            <div class="relative group italic">
                                <i class="fas fa-signature absolute left-8 top-1/2 -translate-y-1/2 text-slate-200 group-focus-within:text-[#FF6B00] transition-all italic font-bold"></i>
                                <input type="text" name="nombre" value="{{ old('nombre', $instructor->ins_nombre) }}" required
                                    class="w-full pl-20 pr-10 py-7 rounded-[2.5rem] bg-slate-50 border-none focus:ring-8 focus:ring-[#FF6B00]/10 focus:bg-white focus:outline-none font-black text-base text-slate-900 transition-all shadow-inner uppercase italic tracking-tight italic">
                            </div>
                        </div>
                        <div class="space-y-4 italic">
                    ...
                    <div class="space-y-4 italic">
                        ...
                        <div class="relative group italic">
                            <i class="fas fa-atom absolute left-8 top-1/2 -translate-y-1/2 text-slate-200 group-focus-within:text-[#FF6B00] transition-all italic font-bold animate-spin-slow italic"></i>
                            <input type="text" name="especialidad" value="{{ old('especialidad', $instructor->ins_especialidad) }}" required
                                class="w-full pl-20 pr-10 py-7 rounded-[2.5rem] bg-slate-50 border-none focus:ring-8 focus:ring-[#FF6B00]/10 focus:bg-white focus:outline-none font-black text-base text-slate-900 transition-all shadow-inner uppercase italic tracking-tight italic">
                        </div>
                    </div>

                    <div class="p-12 rounded-[3.5rem] bg-slate-900 border-none space-y-12 group-hover:shadow-2xl group-hover:shadow-[#FF6B00]/10 transition-all duration-700 italic font-bold border-4 border-white/5 italic">
                        <h4 class="text-[10px] font-black text-orange-400 uppercase tracking-[0.4em] flex items-center gap-5 italic font-bold leading-none italic">
                        ...
                        <div class="space-y-6 italic">
                            ...
                            <div class="relative group italic font-bold">
                                <i class="fas fa-key absolute left-8 top-1/2 -translate-y-1/2 text-white/10 group-focus-within:text-[#FF6B00] transition-all italic font-bold"></i>
                                <input type="password" name="password" placeholder="MINIMO 8 CARACTERES ALFANUMÉRICOS"
                                    class="w-full pl-20 pr-10 py-8 rounded-[2.5rem] bg-white/5 border-none focus:ring-8 focus:ring-[#FF6B00]/20 focus:outline-none font-black text-base text-white transition-all shadow-inner uppercase italic placeholder:text-white/5 tracking-widest italic italic">
                            </div>
                            <div class="p-6 rounded-2xl bg-[#FF6B00]/5 border border-[#FF6B00]/10 italic">
                                <p class="text-[9px] font-black text-[#FF6B00] uppercase tracking-[0.2em] italic leading-relaxed italic text-center italic">
                    ...
                    <div class="flex justify-end pt-10 italic font-bold">
                        <x-button variant="primary" shadow="orange" class="w-full md:w-auto px-16 py-7 rounded-[2rem] text-[11px] font-black uppercase italic shadow-2xl hover:scale-105 transition-all active:scale-95 italic tracking-widest leading-none italic" type="submit">
        ...
        <div class="space-y-12 italic font-bold">
            <x-card class="bg-slate-900 p-12 border-none shadow-2xl rounded-[4rem] text-white italic font-bold border-2 border-white/5 italic" shadow="none">
                <h4 class="text-[10px] font-black text-orange-400 uppercase tracking-[0.4em] mb-14 border-b-2 border-white/5 pb-8 italic text-center leading-none italic font-bold">MÉTRICAS DE IMPACTO</h4>
                
                <div class="space-y-10 italic">
                    <div class="flex items-center justify-between p-8 rounded-[2.5rem] bg-white/5 hover:bg-white/10 transition-all group italic font-bold border-2 border-transparent hover:border-[#FF6B00]/10 italic">
                        <div class="flex items-center gap-6 italic">
                            <div class="w-16 h-16 rounded-2xl bg-[#FF6B00] text-white flex items-center justify-center shadow-2xl shadow-[#FF6B00]/30 group-hover:rotate-12 transition-transform italic border-4 border-white/10 italic">
                                <i class="fas fa-project-diagram italic font-bold"></i>
                            </div>
                            <div class="italic">
                                <span class="block text-[9px] font-black uppercase tracking-[0.3em] text-orange-100/40 italic leading-none italic">MISIONES</span>
            ...
            <x-card class="p-12 bg-white border-none shadow-2xl rounded-[4rem] group italic font-bold italic" shadow="none">
                ...
                <div class="h-5 w-full bg-slate-50 rounded-full overflow-hidden mb-10 shadow-inner p-1.5 italic border-2 border-slate-100">
                    <div class="h-full bg-[#FF6B00] rounded-full transition-all duration-1000 shadow-[0_0_20px_rgba(16,185,129,0.5)] italic" style="width: {{ $progresoPerfil }}%"></div>
                </div>
