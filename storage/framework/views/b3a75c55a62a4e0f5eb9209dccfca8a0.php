<?php $__env->startSection('title', 'Inspírate SENA - Nosotros'); ?>

<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/nosotros.css')); ?>">
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="about-grid">
        ...
        <div class="about-image">
            <img src="<?php echo e(asset('assets/web1.jpg')); ?>" alt="SENA" onerror="this.src='https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=80'">
    ...
    <section style="padding: 100px 8%; text-align: center;">
        ...
        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary" style="padding: 20px 60px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/nosotros.blade.php ENDPATH**/ ?>