...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Panel'); ?> - Inspírate SENA</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-footer">
            <div class="user-info">
                <div class="user-avatar"><?php echo e(strtoupper(substr(session('nombre', 'U'), 0, 1))); ?></div>
                <div class="user-details">
                    <div class="user-name"><?php echo e(session('nombre')); ?> <?php echo e(session('apellido')); ?></div>
                    <div class="user-role">
                        <?php switch(session('rol')):
                            case (1): ?> Aprendiz <?php break; ?>
                            <?php case (2): ?> Instructor <?php break; ?>
                            <?php case (3): ?> Empresa <?php break; ?>
                            <?php case (4): ?> Administrador <?php break; ?>
                        <?php endswitch; ?>
                    </div>
                </div>
    ...
    <div class="main">
        <header class="topbar">
            ...
            <span class="topbar-title"><?php echo $__env->yieldContent('page-title', 'Principal'); ?></span>
            <div class="topbar-right" style="display: flex; align-items: center; gap: 24px;">
                ...
                ?>
                <a href="<?php echo e(route('notificaciones.index')); ?>" title="Notificaciones" style="position:relative; color:var(--text); text-decoration:none;">
                ...
                <span style="font-size:13px; color: var(--text-light); font-weight: 600;"><?php echo e(now()->translatedFormat('d M, Y')); ?></span>
            </div>
        </header>
    ...
    // ── AUTO FLASH ────────────────────────────────────────────────
    <?php if(session('success')): ?> showToast('success', "<?php echo e(addslashes(session('success'))); ?>"); <?php endif; ?>
    <?php if(session('error')): ?>   showToast('error',   "<?php echo e(addslashes(session('error'))); ?>"); <?php endif; ?>
    <?php if(session('warning')): ?> showToast('warning', "<?php echo e(addslashes(session('warning'))); ?>"); <?php endif; ?>
    <?php if($errors->any()): ?> <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> showToast('error', "<?php echo e(addslashes($e)); ?>"); <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>
...
<?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>