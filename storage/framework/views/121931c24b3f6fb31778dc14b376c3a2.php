<?php $__env->startSection('title', 'Publicar Proyecto'); ?>
<?php $__env->startSection('page-title', 'Publicar Proyecto'); ?>
...
<div class="animate-fade-in" style="max-width: 1200px; margin: 0 auto; padding-bottom: 40px;">
    ...
    <div class="instructor-hero" style="margin-bottom: 32px;">
        ...
        <div style="position: relative; z-index: 1;">
            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                <a href="<?php echo e(route('empresa.proyectos')); ?>" style="display: inline-flex; align-items: center; gap: 8px; color: rgba(255,255,255,0.6); text-decoration: none; font-size: 13px; font-weight: 600; transition: color 0.3s;" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.6)'">
    ...
    <form action="<?php echo e(route('empresa.proyectos.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div style="padding: 48px; display: grid; gap: 48px;">
                    ...
                    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 24px;">
                        <div>
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="text" name="titulo" value="<?php echo e(old('titulo')); ?>" required style="width: 100%; padding: 14px 16px 14px 48px; border: 1.5px solid #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 600; outline: none;" placeholder="Ej: Rediseño de Plataforma Logística">
                            </div>
                        </div>
                        <div>
                ...
                <div>
                    ...
                    <div style="margin-bottom: 24px;">
                        ...
                        <textarea name="descripcion" required rows="5" style="width: 100%; padding: 14px 16px; border: 1.5px solid #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 500; outline: none; resize: vertical;" placeholder="Describe los objetivos, alcance y el impacto esperado..."><?php echo e(old('descripcion')); ?></textarea>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div>
                            ...
                            <textarea name="requisitos" required rows="3" style="width: 100%; padding: 14px 16px; border: 1.5px solid #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 500; outline: none; resize: vertical;" placeholder="Herramientas, lenguajes o conocimientos específicos..."><?php echo e(old('requisitos')); ?></textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="habilidades" required rows="3" style="width: 100%; padding: 14px 16px; border: 1.5px solid #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 500; outline: none; resize: vertical;" placeholder="Liderazgo, comunicación, resolución de problemas..."><?php echo e(old('habilidades')); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 20px; justify-content: flex-end; padding-top: 32px; border-top: 2px solid #f1f5f9;">
                    <a href="<?php echo e(route('empresa.proyectos')); ?>" class="btn-premium" style="background: white; color: var(--text-light); border: 1px solid #e2e8f0; box-shadow: none; padding: 14px 28px;">
                        Descartar
                    </a>
...
document.addEventListener('DOMContentLoaded', function() {
    // Map
    const config = {
        lat: <?php echo e(old('latitud') ?? 10.8642); ?>,
        lng: <?php echo e(old('longitud') ?? -74.7777); ?>,
        canEdit: true,
        latInput: 'latitud',
        lngInput: 'longitud',
        onUpdate: function() {}
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/empresa/crear-proyecto.blade.php ENDPATH**/ ?>