<?php $__env->startSection('title', 'Dashboard Aprendiz'); ?>
<?php $__env->startSection('page-title', 'Mi Dashboard'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="instructor-hero" style="padding: 40px 48px; margin-bottom: 32px;">
        ...
        <div style="position: relative; z-index: 1;">
            <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 10px;">
                ...
                <span style="color: rgba(255,255,255,0.6); font-size: 13px; font-weight: 500;"><i class="far fa-calendar-alt" style="margin-right: 6px;"></i><?php echo e(now()->translatedFormat('l, d F')); ?></span>
            </div>
            <h1 style="font-size: 36px; font-weight: 800; color: white; margin-bottom: 8px;">¡Hola de nuevo, <span style="color: #3eb489;"><?php echo e(session('nombre')); ?></span>!</h1>
    ...
    <div class="instructor-stat-grid">
        ...
        <div class="glass-card" style="grid-column: span 2; display: flex; align-items: center; gap: 32px; padding: 40px; border: 1px solid rgba(62,180,137,0.1);">
            ...
            <div>
                <h3 style="font-size: 36px; font-weight: 800; color: var(--text); margin: 0;"><?php echo e($postulacionesAprobadas); ?> Proyectos</h3>
        ...
        <div class="glass-card" style="border: 1px solid rgba(62,180,137,0.1);">
            <div style="display: flex; flex-direction: column; gap: 12px;">
                ...
                <?php if($proximoCierre && $proximoCierre->fecha_finalizacion): ?>
                    <h4 style="font-size: 20px; font-weight: 800; color: #ef4444; margin: 0;"><?php echo e(\Carbon\Carbon::parse($proximoCierre->fecha_finalizacion)->diffForHumans()); ?></h4>
                    <p style="font-size: 12px; color: var(--text-light); margin: 0; font-weight: 500;"><?php echo e(Str::limit($proximoCierre->titulo, 30)); ?></p>
                <?php else: ?>
        ...
        <div class="glass-card" style="border: 1px solid rgba(62,180,137,0.1);">
            <div style="display: flex; flex-direction: column; gap: 12px;">
                ...
                <h4 style="font-size: 28px; font-weight: 800; color: var(--text); margin: 0;"><?php echo e($totalPostulaciones); ?></h4>
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin: 40px 0 28px;">
        ...
        <a href="<?php echo e(route('aprendiz.proyectos')); ?>" style="color: #3eb489; font-weight: 700; text-decoration: none; font-size: 14px; display: flex; align-items: center; gap: 8px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(340px, 1fr)); gap: 24px;">
            ...
            <div style="background: white; border-radius: 20px; overflow: hidden; border: 1px solid rgba(62,180,137,0.1); transition: all 0.3s;">
                ...
                <div style="padding: 24px;">
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                        ...
                        <span style="font-size: 14px; font-weight: 700; color: var(--text-light);"><?php echo e($p->nombre); ?></span>
                    </div>
                    <h4 style="font-size: 20px; font-weight: 800; color: var(--text); margin-bottom: 16px; line-height: 1.3; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;"><?php echo e($p->titulo); ?></h4>
                    
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="font-size: 13px; color: var(--text-light); font-weight: 600;"><i class="fas fa-bolt" style="margin-right: 6px; color: #f59e0b;"></i><?php echo e($p->pro_duracion ?? '8 semanas'); ?></span>
                        <?php if(in_array($p->id, $proyectosAprobados)): ?>
                            <a href="<?php echo e(route('aprendiz.proyecto.detalle', $p->id)); ?>" class="btn-premium" style="padding: 10px 20px; font-size: 13px;">Gestionar</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('aprendiz.proyectos')); ?>" style="padding: 10px 20px; font-size: 13px; background: rgba(62,180,137,0.1); color: #3eb489; border-radius: 10px; font-weight: 700; text-decoration: none;">Detalles</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div style="grid-column: 1 / -1; padding: 5rem 2rem; text-align: center; background: white; border-radius: 20px; border: 1px dashed rgba(62,180,137,0.2);">
                ...
                <a href="<?php echo e(route('aprendiz.proyectos')); ?>" class="btn-premium" style="margin-top: 32px; display: inline-flex;">Explorar Banco de Proyectos</a>
            </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/aprendiz/dashboard.blade.php ENDPATH**/ ?>