<?php $__env->startSection('title', 'Explorar Proyectos - Inspírate SENA'); ?>
<?php $__env->startSection('page-title', 'Banco de Talento y Proyectos'); ?>
...
<div style="max-width: 1200px; margin: 0 auto; padding-bottom: 60px;">
    ...
    <div style="background: linear-gradient(135deg, #0a1a15 0%, #1a2e28 100%); border-radius: 32px; padding: 60px 48px; margin-bottom: 40px; position: relative; overflow: hidden; box-shadow: 0 20px 50px -15px rgba(62,180,137,0.3);">
        ...
        <div style="position: relative; z-index: 1;">
            ...
            <!-- Search Bar -->
            <form action="<?php echo e(route('aprendiz.proyectos')); ?>" method="GET" style="position: relative; max-width: 700px;">
                <i class="fas fa-search" style="position: absolute; left: 24px; top: 50%; transform: translateY(-50%); color: #94a3b8; font-size: 18px;"></i>
                <input type="text" name="buscar" value="<?php echo e(request('buscar')); ?>" placeholder="¿Qué quieres aprender hoy? (ej. React, Marketing, Diseño...)" style="width: 100%; padding: 20px 24px 20px 60px; border-radius: 20px; border: none; background: white; font-size: 15px; font-weight: 600; box-shadow: 0 10px 30px rgba(0,0,0,0.1); outline: none;">
    ...
    <div style="margin-bottom: 32px;">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px;">
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <span style="font-size: 12px; color: var(--text-light); font-weight: 500;">(<?php echo e(count($categorias)); ?> categorías)</span>
            </div>
            <?php if(request()->anyFilled(['buscar', 'categoria'])): ?>
                <a href="<?php echo e(route('aprendiz.proyectos')); ?>" style="font-size: 12px; font-weight: 700; color: #ef4444; text-decoration: none; display: flex; align-items: center; gap: 6px; background: #fef2f2; padding: 8px 14px; border-radius: 20px;">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 10px;">
            <a href="<?php echo e(route('aprendiz.proyectos', array_merge(request()->all(), ['categoria' => '']))); ?>" 
               style="padding: 12px 20px; background: <?php echo e(!request('categoria') ? 'linear-gradient(135deg, #3eb489, #2d9d74)' : 'white'); ?>; color: <?php echo e(!request('categoria') ? 'white' : '#64748b'); ?>; border: <?php echo e(!request('categoria') ? 'none' : '1.5px solid #e2e8f0'); ?>; border-radius: 12px; font-size: 13px; font-weight: 700; text-decoration: none; transition: all 0.3s; display: flex; align-items: center; gap: 8px; box-shadow: <?php echo e(!request('categoria') ? '0 4px 12px rgba(62,180,137,0.3)' : 'none'); ?>;">
                <i class="fas fa-border-all"></i> Todos
            </a>
            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('aprendiz.proyectos', array_merge(request()->all(), ['categoria' => $cat]))); ?>" 
                   style="padding: 12px 20px; background: <?php echo e(request('categoria') == $cat ? 'linear-gradient(135deg, #3eb489, #2d9d74)' : 'white'); ?>; color: <?php echo e(request('categoria') == $cat ? 'white' : '#64748b'); ?>; border: <?php echo e(request('categoria') == $cat ? 'none' : '1.5px solid #e2e8f0'); ?>; border-radius: 12px; font-size: 13px; font-weight: 700; text-decoration: none; transition: all 0.3s; box-shadow: <?php echo e(request('categoria') == $cat ? '0 4px 12px rgba(62,180,137,0.3)' : 'none'); ?>;">
                    <?php echo e($cat); ?>
    ...
    <div style="margin-bottom: 24px; display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
        <div style="display: flex; align-items: center; gap: 10px;">
            <span style="font-size: 20px; font-weight: 800; color: var(--text);"><?php echo e($proyectos->total()); ?></span>
    ...
    <?php if($proyectos->isEmpty()): ?>
        <div style="padding: 5rem 2rem; text-align: center; background: white; border-radius: 24px; border: 1px dashed rgba(62,180,137,0.2);">
            <div style="width: 100px; height: 100px; background: rgba(62,180,137,0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 24px;">
                <i class="fas <?php echo e(request('buscar') || request('categoria') ? 'fa-search' : 'fa-folder-open'); ?>" style="font-size: 40px; color: #3eb489;"></i>
            </div>
            <?php if(request('buscar') || request('categoria')): ?>
                ...
                <p style="color: var(--text-light); max-width: 400px; margin: 0 auto 24px;">No encontramos proyectos que coincidan con tu búsqueda "<?php echo e(request('buscar') ?? request('categoria')); ?>".</p>
                <a href="<?php echo e(route('aprendiz.proyectos')); ?>" style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 24px; background: #3eb489; color: white; border-radius: 12px; font-weight: 700; text-decoration: none;">
                ...
                <div style="background: white; border-radius: 24px; overflow: hidden; border: 1px solid rgba(62,180,137,0.1); transition: all 0.3s;" onmouseover="this.style.transform='translateY(-6px)'; this.style.boxShadow='0 16px 40px rgba(62,180,137,0.15)'" onmouseout="this.style.transform='none'; this.style.boxShadow='none'">
                    ...
                    <div style="padding: 28px;">
                        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 14px;">
                            ...
                            <span style="font-size: 13px; font-weight: 700; color: var(--text-light);"><?php echo e($p->nombre); ?></span>
                        </div>
                        ...
                        <div style="display: flex; gap: 20px; margin-bottom: 24px; padding: 14px; background: rgba(62,180,137,0.03); border-radius: 14px; border: 1px solid rgba(62,180,137,0.08);">
                            <div style="display: flex; align-items: center; gap: 8px; font-size: 12px; color: var(--text-light); font-weight: 600;">
                                <i class="fas fa-clock" style="color: #f59e0b;"></i> <?php echo e($p->duracion_estimada_dias); ?> días
                            </div>
                            <div style="display: flex; align-items: center; gap: 8px; font-size: 12px; color: var(--text-light); font-weight: 600;">
                                <i class="fas fa-users" style="color: #3eb489;"></i> <?php echo e($p->postulados_count ?? 0); ?> postulados
                            </div>
                        </div>
                        ...
                        <div style="margin-top: auto;">
                            ...
                            <?php else: ?>
                                <form action="<?php echo e(route('aprendiz.postular', $p->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/aprendiz/proyectos.blade.php ENDPATH**/ ?>