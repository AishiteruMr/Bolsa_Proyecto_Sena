...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Notificación - SENA'); ?></title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.05), 0 8px 10px -6px rgba(0, 0, 0, 0.01); margin: 0 auto; border: 1px solid #f1f5f9;">
                    ...
                    <tr>
                        <td align="center" style="background: linear-gradient(135deg, #047857 0%, #10b981 100%); padding: 45px 20px; border-bottom: 3px solid #065f46;">
                            <div style="font-size: 42px; margin-bottom: 12px; line-height: 1;"><?php echo $__env->yieldContent('header_icon', '✉️'); ?></div>
                            <h1 style="color: #ffffff; font-size: 24px; font-weight: 700; margin: 0; padding: 0; letter-spacing: -0.5px;"><?php echo $__env->yieldContent('header_title'); ?></h1>
                            <?php if (! empty(trim($__env->yieldContent('header_subtitle')))): ?>
                            <p style="color: #d1fae5; font-size: 15px; margin: 8px 0 0 0; font-weight: 500;"><?php echo $__env->yieldContent('header_subtitle'); ?></p>
                            <?php endif; ?>
                        </td>
                    </tr>
                     ...
                     <tr>
                        <td align="center" style="padding: 24px 0;">
                            <p style="font-size: 12px; color: #94a3b8; margin: 0; font-weight: 500;">
                                &copy; <?php echo e(date('Y')); ?> SENA. Todos los derechos reservados.
                            </p>
                        </td>
                    </tr>
                </table>
...
<?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/emails/layouts/master.blade.php ENDPATH**/ ?>