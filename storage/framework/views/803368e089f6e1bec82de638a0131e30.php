<?php $__env->startSection('title', 'Registro Aprendiz'); ?>
...
<div class="login-page-wrapper">
    ...
    <div class="login-container">
        ...
        <div class="login-content">
            ...
            <form action="<?php echo e(route('registro.aprendiz.post')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="input-row">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="programa" value="<?php echo e(old('programa')); ?>" placeholder="Programa técnico o tecnológico" required>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/auth/registro-aprendiz.blade.php ENDPATH**/ ?>