<?php $__env->startSection('title', 'Perfil Corporativo - Inspírate SENA'); ?>
<?php $__env->startSection('page-title', 'Perfil Corporativo'); ?>
...
<div class="animate-fade-in" style="max-width: 1100px; margin: 0 auto; padding-bottom: 40px;">
    ...
    <div class="instructor-hero" style="padding: 48px;">
        ...
        <div style="display: flex; align-items: center; gap: 32px; position: relative; z-index: 1;">
            <div style="width: 100px; height: 100px; border-radius: 24px; background: rgba(255,255,255,0.1); border: 2px solid rgba(255,255,255,0.15); display: flex; align-items: center; justify-content: center; font-size: 48px; color: white; flex-shrink: 0; backdrop-filter: blur(10px);">
                <?php echo e(strtoupper(substr($empresa->nombre, 0, 1))); ?>
            ...
            <div style="flex: 1;">
                <div style="display:flex; align-items:center; gap:12px; margin-bottom:12px;">
                    ...
                    <span style="color:rgba(255,255,255,0.5); font-size:13px; font-weight:600;">NIT: <?php echo e($empresa->nit); ?></span>
                </div>
                <h1 class="instructor-title"><?php echo e($empresa->nombre); ?></h1>
                <p style="font-size:14px; color:rgba(255,255,255,0.6); font-weight:500;">
                    <i class="fas fa-user-tie" style="margin-right:8px;"></i><?php echo e($empresa->representante); ?> · Representante Legal
                </p>
            ...
            <div style="display:grid; gap:12px; flex-shrink:0;">
                <div style="background:rgba(255,255,255,0.08); border:1px solid rgba(255,255,255,0.12); border-radius:16px; padding:16px 24px; text-align:center; backdrop-filter:blur(10px);">
                    <div style="font-size:32px; font-weight:900; color:white; line-height:1;"><?php echo e($totalProyectos); ?></div>
                ...
                <div style="background:rgba(62,180,137,0.2); border:1px solid rgba(62,180,137,0.3); border-radius:16px; padding:14px 24px; text-align:center;">
                    <div style="font-size:28px; font-weight:900; color:#86efac; line-height:1;"><?php echo e($proyectosActivos); ?></div>
    ...
    <div style="display:grid; grid-template-columns:2fr 1fr; gap:28px; align-items:start;">
        ...
        <div class="glass-card" style="padding:32px;">
            ...
            <form action="<?php echo e(route('empresa.perfil.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div style="display:grid; gap:24px; margin-bottom:28px;">
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="text" name="nombre_empresa" value="<?php echo e(old('nombre_empresa', $empresa->nombre)); ?>" required style="width: 100%; padding: 14px 16px 14px 48px; border: 1.5px solid #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 600; outline: none;" placeholder="Nombre oficial de la empresa">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="text" name="representante" value="<?php echo e(old('representante', $empresa->representante)); ?>" required style="width: 100%; padding: 14px 16px 14px 48px; border: 1.5px solid #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 600; outline: none;" placeholder="Nombre del representante">
                        </div>
                    </div>
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;">
                        <div class="form-group">
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="text" value="<?php echo e($empresa->nit); ?>" disabled style="width: 100%; padding: 14px 16px 14px 48px; border: 1.5px dashed #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 600; background: #f8fafc; color: #94a3b8; outline: none;">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div style="position: relative;">
                                ...
                                <input type="email" value="<?php echo e($empresa->correo_contacto); ?>" disabled style="width: 100%; padding: 14px 16px 14px 48px; border: 1.5px dashed #e2e8f0; border-radius: 12px; font-size: 14px; font-weight: 600; background: #f8fafc; color: #94a3b8; outline: none;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="display:grid; gap:14px;">
                    <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:#eff6ff; border-radius:14px; border:1px solid rgba(0,0,0,0.05);">
                        ...
                        <div>
                            ...
                            <span style="font-size:14px; font-weight:700; color:var(--text);"><?php echo e($empresa->representante ?: '—'); ?></span>
                        </div>
                    </div>
                    <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:#fef2f2; border-radius:14px; border:1px solid rgba(0,0,0,0.05);">
                        ...
                        <div style="min-width:0;">
                            ...
                            <span style="font-size:13px; font-weight:700; color:var(--text); word-break:break-all;"><?php echo e($empresa->correo_contacto); ?></span>
                        </div>
                    </div>
                    <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:rgba(62,180,137,0.1); border-radius:14px; border:1px solid rgba(62,180,137,0.1);">
                        ...
                        <div>
                            ...
                            <span style="font-size:14px; font-weight:700; color:var(--text);"><?php echo e($empresa->nit); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/empresa/perfil.blade.php ENDPATH**/ ?>