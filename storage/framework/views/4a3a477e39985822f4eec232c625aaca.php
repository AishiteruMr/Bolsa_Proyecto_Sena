<?php $__env->startSection('title', 'Panel de Control - Inspírate SENA'); ?>
<?php $__env->startSection('page-title', 'Centro de Mando del Instructor'); ?>
...
<div class="animate-fade-in dashboard-wrapper">
    ...
    <div class="instructor-stat-grid">
        ...
        <div class="instructor-stat-card-lg glass-card">
            ...
            <div>
                <div style="font-size: 44px; font-weight: 800; color: var(--text); line-height: 1;"><?php echo e($proyectosAsignados); ?></div>
        ...
        <div class="instructor-warning-card">
            ...
            <div style="margin-top: 24px;">
                <div style="font-size: 36px; font-weight: 800;"><?php echo e($evidenciasPendientes); ?></div>
        ...
        <div class="glass-card" style="display: flex; flex-direction: column; justify-content: space-between; border-radius: var(--radius); padding: 24px;">
            ...
            <div style="margin-top: 24px;">
                <div style="font-size: 36px; font-weight: 800; color: var(--text);"><?php echo e($totalAprendices); ?></div>
    ...
    <div class="instructor-main-grid">
        ...
        <div>
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px;">
                ...
                <a href="<?php echo e(route('instructor.proyectos')); ?>" style="color: var(--primary); font-weight: 700; text-decoration: none; font-size: 14px; transition: gap 0.3s; display: flex; align-items: center; gap: 6px;" onmouseover="this.style.gap='10px'" onmouseout="this.style.gap='6px'">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $proyectos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="instructor-project-card">
                        ...
                        <div style="padding: 24px; flex: 1; display: flex; flex-direction: column;">
                            <h4 class="instructor-project-title" style="font-size: 17px; margin-bottom:16px;"><?php echo e($p->titulo); ?></h4>
                            <div style="display: flex; gap: 12px; margin-bottom: 20px;">
                                <div class="instructor-small-stat">
                                    <span class="count"><?php echo e($p->postulaciones->where('estado', 'aceptada')->count()); ?></span>
                                    <span class="label">Activos</span>
                                </div>
                                <div class="instructor-small-stat">
                                    <span class="count"><?php echo e($p->postulaciones->where('estado', 'pendiente')->count()); ?></span>
                                    <span class="label">Nuevos</span>
                                </div>
                            </div>
                            <a href="<?php echo e(route('instructor.proyecto.detalle', $p->id)); ?>" class="btn-premium" style="width: 100%; justify-content: center; font-size: 13px; padding: 10px;">
        ...
        <div>
                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    <div style="display: flex; align-items: center; gap: 16px;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="font-size: 16px; font-weight: 800; color: var(--text);"><?php echo e($nuevasPostulaciones); ?> Recientes</div>
                        </div>
                    </div>
                    <div style="display: flex; align-items: center; gap: 16px;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="font-size: 16px; font-weight: 800; color: var(--text);">
                                <?php echo e(($proximoCierre && $proximoCierre->fecha_publicacion) ? \Carbon\Carbon::parse($proximoCierre->fecha_publicacion)->addDays($proximoCierre->duracion_estimada_dias ?? 0)->diffForHumans() : 'Sin eventos'); ?>
            ...
            <div class="instructor-quick-actions">
                ...
                <div style="display: grid; gap: 12px;">
                    <a href="<?php echo e(route('instructor.aprendices')); ?>" class="instructor-action-link">
                        <i class="fas fa-users" style="color: var(--primary);"></i>
                        <span style="font-size: 14px; font-weight: 600;">Base de Aprendices</span>
                    </a>
                    <a href="<?php echo e(route('instructor.perfil')); ?>" class="instructor-action-link">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/instructor/dashboard.blade.php ENDPATH**/ ?>