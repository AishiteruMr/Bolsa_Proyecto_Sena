<?php $__env->startSection('title', 'Registro Instructor'); ?>
...
<div class="login-page-wrapper">
    ...
    <div class="login-container">
        ...
        <div class="login-content">
            ...
            <form action="<?php echo e(route('registro.instructor.post')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="input-row">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="nombre" value="<?php echo e(old('nombre')); ?>" placeholder="Tu nombre" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <i class="fas fa-user"></i>
                            <input type="text" name="apellido" value="<?php echo e(old('apellido')); ?>" placeholder="Tus apellidos" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="documento" value="<?php echo e(old('documento')); ?>" placeholder="Número de documento" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="especialidad" value="<?php echo e(old('especialidad')); ?>" placeholder="Área de especialización" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" name="correo" value="<?php echo e(old('correo')); ?>" placeholder="tu@email.com" required>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/auth/registro-instructor.blade.php ENDPATH**/ ?>