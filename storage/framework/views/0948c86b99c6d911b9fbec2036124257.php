    ...
    <div class="animate-fade-in" style="padding-bottom: 40px;">
        ...
        <div class="instructor-stat-grid">
            ...
            <div class="glass-card" style="padding: 24px; display: flex; align-items: center; gap: 20px;">
                ...
                <div>
                    <div style="font-size: 32px; font-weight: 800; color: #10b981; line-height: 1;"><?php echo e($proyectos->where('estado', 'aprobado')->count()); ?></div>
            ...
            <div class="glass-card" style="padding: 24px; display: flex; align-items: center; gap: 20px;">
                ...
                <div>
                    <div style="font-size: 32px; font-weight: 800; color: #f59e0b; line-height: 1;"><?php echo e($proyectos->where('estado', 'pendiente')->count()); ?></div>
                            ...
                            <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                                ...
                                <td style="padding: 20px 24px;">
                                    ...
                                    <span style="background: <?php echo e($statusClass['bg']); ?>; border: 1px solid <?php echo e($statusClass['border']); ?>; color: <?php echo e($statusClass['text']); ?>; padding: 6px 14px; border-radius: 20px; font-size: 11px; font-weight: 700; display: inline-flex; align-items: center; gap: 6px;">
                                        <i class="fas <?php echo e($statusClass['icon']); ?>"></i>
                                        <?php echo e(Str::title(str_replace('_', ' ', $proyecto->estado))); ?>
