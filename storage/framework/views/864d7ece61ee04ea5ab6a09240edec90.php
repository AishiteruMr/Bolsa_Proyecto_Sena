...
<div id="loader-wrapper">
    ...
    <div id="loader-logo-wrap">
        <img src="<?php echo e(asset('assets/loader-removebg-preview.png')); ?>" alt="Inspírate SENA" id="loader-logo">
    </div>
...
<?php if(session('mostrar_loader')): ?>
    <?php session()->forget('mostrar_loader'); ?>
<script>
(function () {
