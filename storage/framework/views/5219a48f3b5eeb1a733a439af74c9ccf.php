<?php $__env->startSection('title', 'Mis Postulaciones'); ?>
<?php $__env->startSection('page-title', 'Mis Postulaciones'); ?>
...
<div class="animate-fade-in" style="padding-bottom: 40px;">
    ...
    <?php if($postulaciones->count() > 0): ?>
        <div class="instructor-stat-grid" style="margin-bottom: 32px;">
            <div class="glass-card" style="padding: 24px; display: flex; align-items: center; gap: 20px;">
                ...
                <div>
                    <div style="font-size: 32px; font-weight: 800; color: var(--text); line-height: 1;"><?php echo e($postulaciones->count()); ?></div>
            ...
            <div class="glass-card" style="padding: 24px; display: flex; align-items: center; gap: 20px; border-color: #fde68a;">
                ...
                <div>
                    <div style="font-size: 32px; font-weight: 800; color: #f59e0b; line-height: 1;"><?php echo e($postulaciones->where('estado', 'pendiente')->count()); ?></div>
            ...
            <div class="glass-card" style="padding: 24px; display: flex; align-items: center; gap: 20px; border-color: #bbf7d0;">
                ...
                <div>
                    <div style="font-size: 32px; font-weight: 800; color: #10b981; line-height: 1;"><?php echo e($postulaciones->where('estado', 'aceptada')->count()); ?></div>
            ...
            <div class="glass-card" style="padding: 24px; display: flex; align-items: center; gap: 20px; border-color: #fecaca;">
                ...
                <div>
                    <div style="font-size: 32px; font-weight: 800; color: #ef4444; line-height: 1;"><?php echo e($postulaciones->where('estado', 'rechazada')->count()); ?></div>
    ...
    <div style="display: flex; flex-direction: column; gap: 20px;">
        <?php $__empty_1 = true; $__currentLoopData = $postulaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <div class="glass-card" style="padding: 0; overflow: hidden; display: flex; align-items: center; transition: transform 0.3s, box-shadow 0.3s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 16px 32px rgba(62,180,137,0.12)'" onmouseout="this.style.transform='none'; this.style.boxShadow='0 8px 24px rgba(62,180,137,0.06)'">
                <div style="width: 140px; height: 120px; flex-shrink: 0;">
                    <?php if($post->proyecto && $post->proyecto->imagen_url): ?>
                        <img src="<?php echo e($post->proyecto->imagen_url); ?>" alt="" style="width: 100%; height: 100%; object-fit: cover;">
                    <?php else: ?>
                ...
                <div style="flex: 1; padding: 24px; min-width: 0;">
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px; flex-wrap: wrap;">
                        <h4 style="font-size: 18px; font-weight: 800; color: var(--text); margin: 0;"><?php echo e($post->proyecto->titulo ?? 'Sin título'); ?></h4>
                        <span style="background: rgba(62,180,137,0.1); color: #3eb489; padding: 6px 14px; border-radius: 20px; font-size: 11px; font-weight: 700;"><?php echo e($post->proyecto->categoria ?? 'General'); ?></span>
                    </div>
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 20px; font-size: 13px; color: var(--text-light);">
                        <div style="display: flex; align-items: center; gap: 8px; font-weight: 600;">
                            ...
                            <?php echo e($post->proyecto->empresa->nombre ?? 'Empresa no asignada'); ?>

                        </div>
                        <div style="display: flex; align-items: center; gap: 8px; font-weight: 600;">
                            <i class="far fa-calendar-check" style="width: 16px;"></i>
                            Postulado: <?php echo e(\Carbon\Carbon::parse($post->fecha_postulacion)->format('d M, Y')); ?>
                ...
                <div style="padding: 24px; display: flex; align-items: center; gap: 20px; flex-shrink: 0;">
                    <div style="text-align: right;">
                        ...
                        <span style="background: <?php echo e($estadoColor['bg']); ?>; border: 1.5px solid <?php echo e($estadoColor['border']); ?>; color: <?php echo e($estadoColor['text']); ?>; padding: 10px 18px; border-radius: 20px; font-size: 12px; font-weight: 700; display: flex; align-items: center; gap: 8px; white-space: nowrap;">
                            <i class="fas <?php echo e($estadoColor['icon']); ?>"></i> <?php echo e(Str::title(str_replace('_', ' ', $post->estado))); ?>

                        </span>
                    </div>

                    <?php if($post->estado === 'aceptada'): ?>
                        <a href="<?php echo e(route('aprendiz.proyecto.detalle', $post->proyecto_id)); ?>" class="btn-premium" style="padding: 12px 20px;">
    ...
    <?php if($postulaciones->hasPages()): ?>
        <div style="margin-top: 40px; display: flex; justify-content: center;">
            <?php echo e($postulaciones->links()); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/aprendiz/postulaciones.blade.php ENDPATH**/ ?>