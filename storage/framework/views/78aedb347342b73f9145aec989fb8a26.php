<?php $__env->startSection('title', 'Backup de Base de Datos'); ?>
<?php $__env->startSection('page-title', 'Herramientas - Backup'); ?>
...
<div class="animate-fade-in">
    ...
    <div class="backup-actions">
        ...
        <div class="backup-action-card">
            ...
            <form action="<?php echo e(route('admin.backup.crear')); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <div class="backup-action-card">
            ...
            <a href="<?php echo e(route('admin.backup.exportar')); ?>"
    ...
    <div class="auto-info-bar">
        ...
        <div>
            ...
            <?php if($proximoBackup): ?>
                Próximo estimado: <strong><?php echo e($proximoBackup); ?></strong>.
            <?php endif; ?>
    ...
    <div class="backup-table-card">
        <div class="backup-table-header">
            ...
            <span class="backup-count"><?php echo e(count($backups)); ?> archivo(s)</span>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    <div style="width: 42px; height: 42px; background: linear-gradient(135deg, #eff6ff, #dbeafe); border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                                        <i class="fas <?php echo e($backup['tipo'] === 'zip' ? 'fa-file-archive' : 'fa-folder'); ?>" style="color: #3b82f6; font-size: 1rem;"></i>
                                    </div>
                                    <span style="font-weight: 700; color: var(--text); font-size:.875rem;"><?php echo e($backup['nombre']); ?></span>
                                </div>
                            </td>
                            <td>
                                <?php if($backup['automatico']): ?>
                            ...
                            <td style="color: var(--text-light); font-weight: 600; font-size:.875rem;">
                                <?php echo e($backup['fecha']->format('d/m/Y H:i:s')); ?>
                            ...
                            <td>
                                <span style="padding: 6px 14px; background: #f8fafc; border-radius: 20px; font-size: .75rem; font-weight: 700; color: #64748b; border: 1px solid #e2e8f0;">
                                    <?php echo e(number_format($backup['tamano'] / 1024, 2)); ?> KB
                                </span>
                            </td>
                            <td style="text-align: right;">
                                <div style="display:flex; gap:8px; justify-content:flex-end;">
                                    <a href="<?php echo e(route('admin.backup.descargar', $backup['nombre'])); ?>"
                                       class="table-btn btn-download"
                                       title="Descargar">
                                        <i class="fas fa-download"></i>
                                    </a>
                                    <form action="<?php echo e(route('admin.backup.eliminar', $backup['nombre'])); ?>"
                                          method="POST"
                                          style="display:inline;"
                                          onsubmit="return confirm('¿Eliminar el backup \'<?php echo e($backup['nombre']); ?>\'? Esta acción no se puede deshacer.')">
                                        <?php echo csrf_field(); ?>
...
<div class="modal-backdrop" id="modalImportar" onclick="if(event.target===this) this.classList.remove('open')">
    <div class="modal-box">
        ...
        <form action="<?php echo e(url('/admin/backup/importar')); ?>" method="POST" enctype="multipart/form-data" id="formImportar">
            <?php echo csrf_field(); ?>
            ...
            <?php $__errorArgs = ['archivo_backup'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                <div style="color:#dc2626; font-size:.85rem; margin-bottom:16px; display:flex; align-items:center; gap:8px;">
                    <i class="fas fa-times-circle"></i> <?php echo e($message); ?>
...
<script>
    ...
    <?php if($errors->has('archivo_backup')): ?>
        document.getElementById('modalImportar').classList.add('open');
    <?php endif; ?>
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Bolsa_Proyecto_Sena\resources\views/admin/backup.blade.php ENDPATH**/ ?>