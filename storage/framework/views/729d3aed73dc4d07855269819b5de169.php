    ...
    <?php if($proyectos->count() > 0): ?>
        <div class="instructor-stat-grid" style="margin-bottom: 32px;">
            ...
            <div class="glass-card" style="padding: 24px; display: flex; align-items: center; gap: 20px; border-color: #bbf7d0;">
                ...
                <div>
                    <div style="font-size: 32px; font-weight: 800; color: #10b981; line-height: 1;"><?php echo e($evidencias->where('estado', 'aceptada')->count()); ?></div>
            ...
            <div class="glass-card" style="padding: 24px; display: flex; align-items: center; gap: 20px; border-color: #fde68a;">
                ...
                <div>
                    <div style="font-size: 32px; font-weight: 800; color: #f59e0b; line-height: 1;"><?php echo e($evidencias->where('estado', 'pendiente')->count()); ?></div>
                                    ...
                                    <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; flex-wrap: wrap;">
                                        <div style="flex: 1; min-width: 280px;">
                                            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                                                <span style="width: 32px; height: 32px; border-radius: 10px; background: <?php echo e($stateColor['bg']); ?>; color: <?php echo e($stateColor['text']); ?>; display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 800; flex-shrink: 0;">
                                        ...
                                        <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 10px; flex-shrink: 0;">
                                                <span style="background: <?php echo e($stateColor['bg']); ?>; color: <?php echo e($stateColor['text']); ?>; border: 1.5px solid <?php echo e($stateColor['border']); ?>; padding: 8px 16px; border-radius: 20px; font-size: 12px; font-weight: 800; white-space: nowrap; display: flex; align-items: center; gap: 8px;">
                                                    <i class="fas <?php echo e($stateColor['icon']); ?>"></i> <?php echo e(Str::title(str_replace('_', ' ', $evidencia->estado))); ?>
