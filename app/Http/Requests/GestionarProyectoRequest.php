...
class GestionarProyectoRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'metodologia.file' => 'El archivo de metodología no es válido.',
            'metodologia.mimes' => 'La metodología debe ser un archivo PDF, DOC o DOCX.',
            'metodologia.max' => 'La metodología no debe superar los 5MB.',
