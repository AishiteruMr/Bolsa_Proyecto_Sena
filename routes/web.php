...
Route::post('/enviar-recuperacion', [AuthController::class, 'enviarEnlaceRecuperacion'])->name('auth.enviar-recuperacion')->middleware('throttle:3,60');
...
Route::post('/restablecer-contraseña', [AuthController::class, 'restablecerContraseña'])->name('auth.restablecer-contraseña')->middleware('throttle:3,60');
...
Route::post('/registro/aprendiz', [AuthController::class, 'registrarAprendiz'])->name('registro.aprendiz.post')->middleware('throttle:3,60');
Route::post('/registro/empresa', [AuthController::class, 'registrarEmpresa'])->name('registro.empresa.post')->middleware('throttle:3,60');
Route::post('/registro/instructor', [AuthController::class, 'registrarInstructor'])->name('registro.instructor.post')->middleware('throttle:3,60');
...
Route::middleware(['auth.custom', 'rol:1'])->prefix('aprendiz')->name('aprendiz.')->group(function () {
    ...
    Route::post('/proyectos/{id}/postular', [AprendizController::class, 'postular'])->name('postular')->middleware('throttle:5,60');
    ...
    Route::post('/proyectos/{proId}/etapas/{etaId}/evidencia', [AprendizController::class, 'enviarEvidencia'])->name('evidencia.enviar')->middleware('throttle:10,60');
    ...
    Route::put('/perfil', [AprendizController::class, 'actualizarPerfil'])->name('perfil.update')->middleware('throttle:5,60');
});
...
Route::middleware(['auth.custom', 'rol:3'])->prefix('empresa')->name('empresa.')->group(function () {
    ...
    Route::post('/proyectos', [EmpresaController::class, 'guardarProyecto'])->name('proyectos.store')->middleware('throttle:10,60');
    Route::get('/proyectos/{id}/editar', [EmpresaController::class, 'editarProyecto'])->name('proyectos.edit');
    Route::put('/proyectos/{id}', [EmpresaController::class, 'actualizarProyecto'])->name('proyectos.update')->middleware('throttle:10,60');
    Route::delete('/proyectos/{id}', [EmpresaController::class, 'eliminarProyecto'])->name('proyectos.destroy')->middleware('throttle:5,60');
    ...
    Route::post('/postulaciones/{id}/estado', [EmpresaController::class, 'cambiarEstadoPostulacion'])->name('postulaciones.estado')->middleware('throttle:10,60');
    Route::get('/perfil', [EmpresaController::class, 'perfil'])->name('perfil');
    Route::put('/perfil', [EmpresaController::class, 'actualizarPerfil'])->name('perfil.update')->middleware('throttle:5,60');
});
...
Route::middleware(['auth.custom', 'rol:2'])->prefix('instructor')->name('instructor.')->group(function () {
    ...
    Route::post('/postulaciones/{id}/estado', [InstructorController::class, 'cambiarEstadoPostulacion'])->name('postulaciones.estado')->middleware('throttle:10,60');

    // RUTAS PARA ETAPAS
    Route::post('/proyectos/{id}/etapas', [InstructorController::class, 'crearEtapa'])->name('etapas.crear')->middleware('throttle:10,60');
    Route::put('/etapas/{id}', [InstructorController::class, 'editarEtapa'])->name('etapas.editar')->middleware('throttle:10,60');
    Route::delete('/etapas/{id}', [InstructorController::class, 'eliminarEtapa'])->name('etapas.eliminar')->middleware('throttle:5,60');

    // RUTAS PARA IMAGEN DE PROYECTO
    Route::post('/proyectos/{id}/imagen', [InstructorController::class, 'subirImagenProyecto'])->name('proyectos.imagen')->middleware('throttle:5,60');

    // RUTAS PARA EVIDENCIAS
    Route::get('/proyectos/{id}/evidencias', [InstructorController::class, 'verEvidencias'])->name('evidencias.ver');
    Route::put('/evidencias/{id}', [InstructorController::class, 'calificarEvidencia'])->name('evidencias.calificar')->middleware('throttle:20,60');
